...
2. The app calls `/api/resolve` to verify the URL can actually be downloaded/streamed.
3. After validation, it generates a Vercel-hosted URL in the format `/mp4/<FILE_ID>.mp4`.
