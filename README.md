...
This gives you a stable app URL that behaves like an MP4 endpoint for VLC/Infuse/nPlayer. If resolve/proxy is unavailable, the UI falls back to a direct Google Drive download URL.
