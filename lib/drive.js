...
async function fetchDriveStream(fileId, options = {}) {
  ...
  for (let i = 0; i < 7; i += 1) {
    ...
    if (contentType.includes('text/html')) {
      ...
      throw new Error('Drive returned an HTML interstitial page instead of media. Ensure file is shared publicly.');
    }
  ...
  throw new Error('Unable to resolve a downloadable stream from Google Drive. Ensure the file is public and downloadable.');
}
